...
// each site's photos fanned out around it when clicked. Plain SVG (for the
// connecting lines) + absolutely-positioned HTML nodes on top — no WebGL
// context, so it works identically on desktop and mobile and costs nothing
// when offscreen.
//
// The site grouping (data/job-sites.js) was arranged by hand via a
// drag-and-drop edit mode and is now final — this is the locked, view-only
// presentation of that arrangement.
